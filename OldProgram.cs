    ...
    public class BinaryWorker
{
    ...
    /// </summary>
    private string _path; // Приватное поле для хранения значения

    internal string Path
    {
        get { return _path; } // Возвращаем значение из приватного поля
        set { _path = value; } // Устанавливаем значение в приватное поле
    }
...
public class Pixel
{
    ...
    public Pixel(string[] parts, bool wall = false)
    {
        ...
        color = ToBytes(parts[3]);
        WallAtached = DefTorchs.IndexOf(parts[1]) != -1 ? true : false;
    }
